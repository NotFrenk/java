...
public class Conversioni {
    ...
    public static Rubrica daRubricaDtoARubrica(RubricaDto dto) {
        ...
        List<Contatto> lista = listaD.stream().map(t -> Conversioni.daContattoDtoAContatto(t)).collect(Collectors.toList());
    ...
    public static RubricaDto daRubricaARubricaDto(Rubrica rubrica) {
        ...
        List<ContattoDto> listaD = lista.stream().map(t -> Conversioni.daContattoAContattoDto(t)).collect(Collectors.toList());
